...
import com.practicum.playlistmaker.search.data.network.retrofit.RetrofitApi
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fun searchTrack() {
            if (binding.findField.text.isNotEmpty()) {
                ...
                itunesService.search(binding.findField.text.toString()).enqueue(object : Callback<TrackResponse>
                    {
